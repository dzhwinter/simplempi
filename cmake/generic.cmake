...
function(cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    target_link_libraries(${TARGET_NAME} ${_DEPS} mpi_gtest_main gtest gflags)
    add_dependencies(${TARGET_NAME} ${cc_test_DEPS} mpi_gtest_main gtest gflags)
...
function(nv_test TARGET_NAME)
  if (WITH_GPU AND WITH_TESTING)
    ...
    target_link_libraries(${TARGET_NAME} ${nv_test_DEPS} gtest_main gtest gflags)
    add_dependencies(${TARGET_NAME} ${nv_test_DEPS} gtest_main gtest gflags)
